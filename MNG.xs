...
#
# ------------------- autogenerated and untested functions --------
...
#
#        <list> mng_getchunk_ihdr       (hHandle, hChunk)
#        <list> mng_getchunk_plte       (hHandle, hChunk)
#        <list> mng_getchunk_idat       (hHandle, hChunk)
#        <list> mng_getchunk_trns       (hHandle, hChunk)
#        <list> mng_getchunk_gama       (hHandle, hChunk)
#        <list> mng_getchunk_chrm       (hHandle, hChunk)
#        <list> mng_getchunk_srgb       (hHandle, hChunk)
#        <list> mng_getchunk_iccp       (hHandle, hChunk)
#        <list> mng_getchunk_text       (hHandle, hChunk)
#        <list> mng_getchunk_ztxt       (hHandle, hChunk)
#        <list> mng_getchunk_itxt       (hHandle, hChunk)
#        <list> mng_getchunk_bkgd       (hHandle, hChunk)
#        <list> mng_getchunk_phys       (hHandle, hChunk)
#        <list> mng_getchunk_sbit       (hHandle, hChunk)
#        <list> mng_getchunk_splt       (hHandle, hChunk)
#        <list> mng_getchunk_hist       (hHandle, hChunk)
#        <list> mng_getchunk_time       (hHandle, hChunk)
#        <list> mng_getchunk_mhdr       (hHandle, hChunk)
#        <list> mng_getchunk_loop       (hHandle, hChunk)
#        <list> mng_getchunk_endl       (hHandle, hChunk)
#        <list> mng_getchunk_defi       (hHandle, hChunk)
#        <list> mng_getchunk_basi       (hHandle, hChunk)
#        <list> mng_getchunk_clon       (hHandle, hChunk)
#        <list> mng_getchunk_past       (hHandle, hChunk)
#        <list> mng_getchunk_past_src   (hHandle, hChunk)
#        <list> mng_getchunk_disc       (hHandle, hChunk)
#        <list> mng_getchunk_back       (hHandle, hChunk)
#        <list> mng_getchunk_fram       (hHandle, hChunk)
#        <list> mng_getchunk_move       (hHandle, hChunk)
#        <list> mng_getchunk_clip       (hHandle, hChunk)
#        <list> mng_getchunk_show       (hHandle, hChunk)
#        <list> mng_getchunk_term       (hHandle, hChunk)
#        <list> mng_getchunk_save       (hHandle, hChunk)
#        <list> mng_getchunk_save_entry (hHandle, hChunk)
#        <list> mng_getchunk_seek       (hHandle, hChunk)
#        <list> mng_getchunk_expi       (hHandle, hChunk)
#        <list> mng_getchunk_fpri       (hHandle, hChunk)
#        <list> mng_getchunk_need       (hHandle, hChunk)
#        <list> mng_getchunk_phyg       (hHandle, hChunk)
#        <list> mng_getchunk_jhdr       (hHandle, hChunk)
#        <list> mng_getchunk_jdat       (hHandle, hChunk)
#        <list> mng_getchunk_jdaa       (hHandle, hChunk)
#        <list> mng_getchunk_dhdr       (hHandle, hChunk)
#        <list> mng_getchunk_prom       (hHandle, hChunk)
#        <list> mng_getchunk_pplt       (hHandle, hChunk)
#        <list> mng_getchunk_pplt_entry (hHandle, hChunk)
#        <list> mng_getchunk_drop       (hHandle, hChunk)
#        <list> mng_getchunk_dbyk       (hHandle, hChunk)
#        <list> mng_getchunk_ordr       (hHandle, hChunk)
#        <list> mng_getchunk_ordr_entry (hHandle, hChunk)
#        <list> mng_getchunk_magn       (hHandle, hChunk)
#        <list> mng_getchunk_unknown    (hHandle, hChunk)
#        mng_putchunk_ihdr              (hHandle, iWidth, iHeight, iBitdepth, iColortype, iCompression, iFilter, iInterlace)
#        mng_putchunk_plte              (hHandle, iCount, aPalette)
#        mng_putchunk_idat              (hHandle, iRawlen, pRawdata)
#        mng_putchunk_iend              (hHandle)
...
#        mng_putchunk_jhdr              (hHandle, iWidth, iHeight, iColortype, iImagesampledepth, iImagecompression, iImageinterlace, iAlphasampledepth, iAlphacompression, iAlphafilter, iAlphainterlace)
#        mng_putchunk_jdat              (hHandle, iRawlen, pRawdata)
#        mng_putchunk_jdaa              (hHandle, iRawlen, pRawdata)
#        mng_putchunk_jsep              (hHandle)
#        mng_putchunk_dhdr              (hHandle, iObjectid, iImagetype, iDeltatype, iBlockwidth, iBlockheight, iBlockx, iBlocky)
#        mng_putchunk_prom              (hHandle, iColortype, iSampledepth, iFilltype)
#        mng_putchunk_ipng              (hHandle)
...
mng_dummy()
   ...
   /*
      ===============================================================================
               These are the functions that I still have to implement.
      ===============================================================================
